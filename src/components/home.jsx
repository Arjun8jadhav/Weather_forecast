   ...
   return (
      <>
         ...
         <Container maxWidth="sm" style={{ marginTop: '100px', alignItems: 'center', justifyContent: 'center' }} >
            ...
            <Typography variant='p' align='center' gutterBottom>This weather forecast app allows users to search for weather conditions in any city, displaying details like temperature, wind speed, humidity, and daily chance of rain. Additionally, the app visualizes rain probability over a week using a line chart.</Typography>
